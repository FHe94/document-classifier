...
class ModelConfig:
    ...
    def __init__(self, model_name, model_path, dictionary_path, document_processor):
...
class ModelConfigParser:
    ...
    def write_config(self, config_file_path, model_name, model_path, dictionary_path, document_processor):
        out_dict = {
